...
const Footer = () => {
  ...
  return (
    <footer className="relative rounded-2xl w-full p-8 overflow-hidden">
      ...
      <div className="relative flex flex-col gap-8">
        {/* Main Flex Layout */}
        <div className="flex flex-wrap gap-8 justify-between relative z-10">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 flex-1 min-w-[220px]">
            ...
            {/* Social Icons directly under logo */}
            <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-2 relative z-10">
              {icons.map(({ Icon, color, label }, idx) => (
                <div
                  key={idx}
                  className="relative group w-10 h-10 flex items-center justify-center"
          ...
          {/* Right - Contacts */}
          <div className="flex flex-col gap-4 text-gray-800 dark:text-gray-200 flex-1 min-w-[220px]">
            <h5 className="text-xl font-bold mb-2 dark:text-white text-purple-400">
              Contacts
            </h5>
            <div className="flex items-center gap-3 group">
        ...
        <p className="text-md text-gray-600 dark:text-gray-400 text-center  relative z-10">
          © {new Date().getFullYear()} Naqvix. All rights reserved.
        </p>
      </div>
    </footer>

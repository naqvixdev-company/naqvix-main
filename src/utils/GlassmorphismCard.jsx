...
const GlassmorphismCard = ({
  ...
  textSize = "text-lg",
  glowColors = {
    dark: "from-blue-500/25 via-blue-400/20 to-purple-500/15",
    light: "from-blue-400/35 via-blue-300/25 to-purple-400/20",
  },
  secondaryGlow = {
    dark: "from-blue-600/15 via-blue-500/10 to-violet-400/8",
    light: "from-blue-500/25 via-blue-400/15 to-violet-300/15",
  },
  borderGlow = {
    dark: "from-blue-500/35 via-blue-400/30 to-purple-500/25",
    light: "from-blue-400/45 via-blue-300/35 to-purple-400/30",
  },
  showParticles = true,
  showCorners = true,
  showShimmer = true,
  ...
  const primaryGlow = getGlowClass(
    glowColors,
    "from-blue-500/25 via-blue-400/20 to-purple-500/15"
  );
  const secondGlow = getGlowClass(
    secondaryGlow,
    "from-blue-600/15 via-blue-500/10 to-violet-400/8"
  );
  const borderGlowClass = getGlowClass(
    borderGlow,
    "from-blue-500/35 via-blue-400/30 to-purple-500/25"
  );
    ...
    <div className={`relative group ${className}`}>
      ...
      <div className="relative overflow-hidden rounded-2xl">
        ...
        {showParticles && (
          <div className="absolute inset-0 overflow-hidden rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700">
            <div className="absolute top-4 left-8 w-1 h-1 bg-blue-500 dark:bg-blue-400 rounded-full animate-pulse delay-100"></div>
            <div className="absolute top-12 right-12 w-2 h-2 bg-blue-600 dark:bg-blue-500 rounded-full animate-pulse delay-300"></div>
            <div className="absolute bottom-8 left-16 w-1 h-1 bg-blue-400 dark:bg-blue-300 rounded-full animate-pulse delay-500"></div>
            <div className="absolute bottom-16 right-8 w-1 h-1 bg-purple-500 dark:bg-purple-400 rounded-full animate-pulse delay-700"></div>
            <div className="absolute top-1/2 left-4 w-1 h-1 bg-blue-500 dark:bg-blue-400 rounded-full animate-pulse delay-200"></div>
            <div className="absolute top-1/3 right-6 w-1 h-1 bg-indigo-500 dark:bg-indigo-400 rounded-full animate-pulse delay-600"></div>
          </div>
        )}
        ...
        {showCorners && (
          <>
            <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-blue-500/60 dark:border-blue-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200"></div>
            <div className="absolute top-2 right-2 w-4 h-4 border-r-2 border-t-2 border-blue-600/60 dark:border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-300"></div>
            <div className="absolute bottom-2 left-2 w-4 h-4 border-l-2 border-b-2 border-blue-400/60 dark:border-blue-300/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-400"></div>
            <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-purple-500/60 dark:border-purple-400/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-500"></div>
          </>
        )}
      </div>
    </div>

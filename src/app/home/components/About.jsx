...
const About = () => {
  ...
  return (
    ...
    <div className="w-full mt-10 mb-5 flex md:flex-row flex-col items-center justify-center gap-10 p-5">
      ...
      {/* Visual Content Area */}
      <aside className="w-full md:w-1/3 flex items-center justify-center" aria-label="About Naqvix visual representation">
        <figure className="relative">
          ...
          <Image
            ...
            className={`rounded-2xl transition-opacity duration-300 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
            priority={false}
          ...
          <figcaption className="sr-only">
            Team members at Naqvix working together on innovative technology solutions
          </figcaption>
        </figure>
      </aside>

  ...
  return (
    <div className="w-full h-[50vh]  lg:h-[90vh] flex flex-col-reverse lg:flex-row items-center lg:justify-between justify-center transition-colors duration-1000 dark:bg-[#0F0E0E] mb-5 px-6 md:px-12">
      ...
      <header className="w-full  lg:w-[60%] flex flex-col items-start text-left space-y-4">
        ...
        >
          We Handle the Work, You Focus on Growth
        </h1>
        ...
        >
          Running a business is tough, but it doesn’t have to be overwhelming.
          At NAQVIX, we take care of the heavy lifting: from customer support
          and marketing to AI solutions and finance. So you can focus on what
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Naqvix',
              description:
                'Empowering businesses with technology, intelligence, and innovation. End-to-end solutions including AI, development, automation, and analytics.',
